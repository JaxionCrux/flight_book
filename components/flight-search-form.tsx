...
export function FlightSearchForm() {
  ...
  const handleDateSelect = (range: { from?: Date; to?: Date }) => {
    ...
    } else if (tripType === "one_way" && range.from) {
      // For one-way trips, close the date picker after selecting a single date
      setDatePickerOpen(false)
    }
  }
          ...
          {tripType !== "multi_city" ? (
            ...
            <div className="search-form-mobile">
              ...
              <div className="mobile-form-grid">
                  ...
                  <Popover open={datePickerOpen} onOpenChange={setDatePickerOpen}>
                    ...
                    >
                      <div className="calendar-wrapper">
                        ...
                        <CalendarComponent
                          mode={tripType === "one_way" ? "single" : "range"}
                          selected={tripType === "one_way" ? startDate : { from: startDate, to: endDate }}
                          onSelect={
                            tripType === "one_way"
                              ? (date) => {
                                  if (date) {
                ...
                {/* Passengers Field */}
                <div className="mobile-form-field">
                  <div className="form-field-label">Passengers & Class</div>
                  <Popover open={passengersOpen} onOpenChange={setPassengersOpen}>
                    <PopoverTrigger asChild>
                      <button type="button" className="form-field-input">
                        <User className="form-field-icon w-5 h-5" />
                        <div className="form-field-text passengers-field-text">{formatPassengersText()}</div>
                      </button>
                    </PopoverTrigger>
                    <PopoverContent
                      className="passengers-popover"
                      align="start"
                      side="bottom"
                      sideOffset={5}
                      alignOffset={-10}
                    >
                      <div className="passengers-content">
                        <div className="passengers-section">
                          <h4 className="passengers-section-title">Passengers</h4>
                          <div className="passengers-counter">
                            <span className="passengers-type">Adults</span>
                          ...
                          <div className="cabin-class-options">
                            {[
                              ...
                              <button
                                key={cabin.value}
                                type="button"
                                className={`cabin-class-option ${cabinClass === cabin.value ? "selected" : ""}`}
                        ...
                        <button type="button" className="done-button" onClick={() => setPassengersOpen(false)}>
                          Done
                        </button>
                      </div>
                    </PopoverContent>
        ...
        <form onSubmit={handleSubmit} className="relative">
          {tripType !== "multi_city" ? (
            ...
            <div className="search-form-desktop">
              ...
              {/* Passengers Field */}
              <div className="desktop-field flex-1">
                <div className="desktop-field-label">Passengers & Class</div>
                <Popover open={passengersOpen} onOpenChange={setPassengersOpen}>
                  <PopoverTrigger asChild>
                    <button type="button" className="desktop-field-content w-full text-left">
                      <User className="desktop-field-icon" />
                      <span>{`${adults} Adult${adults > 1 ? "s" : ""}, ${cabinClass.charAt(0).toUpperCase() + cabinClass.slice(1).replace("_", " ")}`}</span>
                    </button>
                  </PopoverTrigger>
                  <PopoverContent className="passengers-popover" align="end">
                        ...
                        <div className="space-y-2">
                          {["economy", "premium_economy", "business", "first"].map((cabin) => (
                            <button
                              key={cabin}
                              type="button"
                              className={`cabin-class-option ${cabinClass === cabin ? "selected" : ""}`}
