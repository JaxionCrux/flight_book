  ...
  if (!flightOffer) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-white/70 mb-6">The flight you're looking for doesn't exist or has expired.</p>
        <Button
          onClick={() => router.push("/")}
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <h3 className="text-xl font-semibold">{flightOffer.owner.name}</h3>
            </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-center justify-between">
                          <div>
                            <p className="font-semibold text-lg">{format(new Date(segment.departing_at), "HH:mm")}</p>
                            <p className="text-sm">
                          ...
                          <div>
                            <p className="font-semibold text-lg">{format(new Date(segment.arriving_at), "HH:mm")}</p>
                            <p className="text-sm">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex justify-between">
              <span>Base fare</span>
              <span>
                {Number.parseFloat(flightOffer.base_amount).toFixed(2)} {flightOffer.base_currency}
              </span>
            </div>
            <div className="flex justify-between">
              <span>Taxes and fees</span>
              <span>
                {Number.parseFloat(flightOffer.tax_amount).toFixed(2)} {flightOffer.tax_currency}
              </span>
            </div>
            <Separator className="bg-white/10" />
            <div className="flex justify-between font-semibold text-lg">
              <span>Total</span>
              <span>
                {Number.parseFloat(flightOffer.total_amount).toFixed(2)} {flightOffer.total_currency}
              </span>
            </div>
